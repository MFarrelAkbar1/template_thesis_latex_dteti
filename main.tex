...
\author{Muhammad Farrel Akbar}{22/492806/TK/53947}
% Input the thesis' title
\title{Manajemen Perangkat Lunak Standar ISO27001/2022 Secure Coding untuk Peningkatan dan Konversi Versi Web App dengan Memanfaatkan AI dan Perangkat Opensource.}
...
\major{<<Major>>}
\yearsubmit{3 Juni 2026}
\examdate{<<Exam date>>}
% Name of thesis supervisors/promotors
\addsupervisor{Dani Adhipta, S.Si., M.T.}{NIP. 196907262000121001}
\addsupervisor{Addin Suwastono, Ir., S.T., M.Eng., IPM.}{NIP. 197111171998031003}
...
\usepackage{colortbl}
\usepackage{makecell}
\definecolor{tableheadblack}{RGB}{51,51,51}
\definecolor{tableheadblue}{RGB}{41,128,185}
\definecolor{tableheadred}{RGB}{192,57,43}
\definecolor{tablerowgray}{gray}{0.93}
% Di preamble, setelah \usepackage{listings}
...
\chapterstatementpdf{pernyataan-bebas-plagiasi.pdf}
...
%\chapterappendixadd{contents/appendix/appendix-latex}            % kosong
%\chapterappendixadd{contents/appendix/appendix-penulisan-referensi} % kosong
\chapterappendixadd{contents/appendix/appendix-github}
\chapterappendixadd{contents/appendix/appendix-pseudocode}
\chapterappendixadd{contents/appendix/appendix-code}
\chapterappendixadd{contents/appendix/appendix-blind-rating}
