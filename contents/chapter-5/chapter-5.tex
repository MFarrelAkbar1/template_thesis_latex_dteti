...
sehingga dapat langsung digunakan sebagai dokumentasi audit tanpa
pekerjaan manual tambahan, menjawab kebutuhan nyata organisasi yang
sedang dalam proses sertifikasi dan memerlukan bukti tertulis bahwa
migrasi kode dilakukan dengan memperhatikan standar keamanan yang
berlaku.
...
selama ini tersembunyi di balik kelenturan sistem tipe pada PHP versi
lama.
...
empiris yang relevan bagi siapa pun yang ingin menerapkan pendekatan
serupa. \textit{Format Compliance Rate} dan \textit{Syntax Validity
...
\begin{enumerate}
    ...
    QLoRA dapat dilakukan menggunakan penelitian ini sebagai 
    \textit{baseline}.

    \item Akurasi laporan PHPStan pada basis kode 
    CodeIgniter 3.x dapat ditingkatkan melalui \textit{custom 
    stubs} atau konfigurasi \textit{baseline} PHPStan, sehingga 
    hanya temuan yang muncul akibat konversi yang dilaporkan.
    ...
    pemrograman lain dapat dijajaki. Arsitektur modular 
