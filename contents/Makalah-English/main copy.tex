...
Fourth, among five locally running open-source LLMs evaluated
under zero-shot and per-model optimized conditions, Qwen2.5-Coder
7b is recommended for pipeline integration: it achieved SVR =
100\% in every experimental condition despite ignoring format
instructions, and demonstrated superior semantic understanding
in remediation suggestions. FCR and SVR proved to be
independent, uncorrelated dimensions; SVR is the more
practically meaningful metric for automated code quality
assessment.

Future work should strengthen LLM evaluation with automated
semantic test suites, develop CodeIgniter 3.x stubs to reduce
PHPStan false positives, and extend the pipeline to support
CI/CD integration and additional programming languages.
