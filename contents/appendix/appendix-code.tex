...
% --------------------------------------------------------
\section*{A.2 DeepSeek Coder 6.7b}
% --------------------------------------------------------
...
generate must be syntactically valid and pass php -l (lint check).
Mentally verify your code compiles without errors before writing
it. Never output PHP with syntax errors.
\end{lstlisting}
\end{small}
