...
(seed=42) dari 244 \textit{file} valid menggunakan modul 
\texttt{accuracy\_validator.py}.
...
Hasilnya adalah 2.354 temuan, yang setelah penyaringan 318 
\textit{false positive} dari \textit{framework} CodeIgniter 3 
(\textit{CI3 noise}) menjadi 2.036 temuan bersih. Distribusi 
temuan berdasarkan kontrol ISO/IEC 27001:2022 ditunjukkan pada 
Gambar~\ref{fig:phpstan-iso-dti}.
...
SSRF dari Semgrep masih terbuka & \texttt{PARTIAL} \\
\hline
\end{tabularx}
\end{table}
...
ukuran dataset yang lebih besar (245 vs 326 \textit{file}) dan penggunaan 
