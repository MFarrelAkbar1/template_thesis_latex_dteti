...
\begin{longtable}{|l|p{3.5cm}|p{6cm}|p{2.5cm}|}
...
dengan $\sigma_m = 0{,}000$, karena tidak satu pun respons 
menghasilkan baris \texttt{CONFIDENCE:} yang dapat di-\textit{parse}. 
Khusus untuk Qwen2.5-Coder, ketiadaan skor ini tidak mengindikasikan ketidakmampuan, 
melainkan mencerminkan karakteristik respons model yang 
mengabaikan instruksi format sambil tetap mengerjakan tugas utama
dengan baik. Waktu inferensi Qwen2.5-Coder (10,0 detik) adalah 
yang tertinggi ddibandingkan model lain, selaras dengan respons yang 
lebih panjang dan detail yang dihasilkannya.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.67\textwidth]{contents/chapter-4/validation/validation_accuracy_qwen_2_similarity.png}
...
Informasi (DTI) Universitas Gadjah Mada. Aplikasi ini dibangun 
di atas \textit{framework} CodeIgniter 3 dengan persyaratan 
versi PHP $\geq$ 7.0. \textit{Pipeline} dijalankan terhadap 
...
Gambar~\ref{fig:rector-bar-dti} dan 
Gambar~\ref{fig:rector-pie-dti}.

\begin{figure}[h]
    \centering
    \includegraphics[width=0.65\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_qwen_2a_rector_bar.png}
    \caption{Ringkasan hasil konversi Rector terhadap 326 
    \textit{file} PHP dataset CBT DTI UGM (diagram batang)}
    \label{fig:rector-bar-dti}
\end{figure}

\begin{figure}[h]
    \centering
    \includegraphics[width=0.5\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_qwen_2b_rector_pie.png}
    \caption{Proporsi hasil konversi Rector dataset CBT DTI UGM 
    (diagram lingkaran)}
