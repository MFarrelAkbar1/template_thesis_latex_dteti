...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.8\textwidth]{contents/chapter-4/llm_chart_20260425_212836_2_format_compliance.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{contents/chapter-4/llm_quality_chart_20260425_122619.png}
...
Gambar~\ref{fig:rector-bar-pie-dti}.

\begin{figure}[h]
    \centering
    \includegraphics[width=1\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_qwen_2_rector_combined.png}
    \caption{Ringkasan hasil konversi Rector terhadap 326 \textit{file} PHP dataset CBT DTI UGM dan Proporsi hasil konversi Rector (diagram lingkaran) berdasarkan jumlah \textit{file} yang berhasil dikonversi, dilewati, dan gagal}
    \label{fig:rector-bar-pie-dti}
\end{figure}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.98\textwidth]{contents/chapter-4/comparison/comparison_qwen_2_rector_conversion.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{contents/chapter-4/comparison/comparison_qwen_4_summary.png}
