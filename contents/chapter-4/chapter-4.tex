...
\begin{longtable}{|l|p{3.5cm}|p{6cm}|l|}
...
1.266 temuan PHPStan kategori \textit{undefined}/\textit{not found} 
yang dipetakan ke kontrol ini & \texttt{NON\_COMPLIANT} \\
\hline
...
\hline
A.8.29 & \textit{Security Testing in Development} & 10 temuan SSRF dari Semgrep masih terbuka & \texttt{NON\_COMPLIANT} \\
\end{longtable}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=1.0\textwidth]{contents/chapter-4/llm_quality_chart_20260425_122619.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{contents/chapter-4/validation/validation_metrics_chart.png}
...
sekitar 41 menit, dengan komponen terbesar adalah AI Engine 
(DeepSeek Coder 6.7b via Ollama) yang membutuhkan sekitar 
39 menit untuk memproses 11 temuan Semgrep dalam 165 percobaan 
eksperimen komparasi. Tahap konversi Rector dan analisis 
PHPStan secara gabungan hanya membutuhkan sekitar 2 menit.
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.7\textwidth]{contents/chapter-4/validation/validation_accuracy_chart_3_coverage.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{contents/chapter-4/validation/validation_accuracy_chart_1_sampling.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.85\textwidth]{contents/chapter-4/validation/validation_accuracy_chart_2_similarity.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_full_2a_rector_bar.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.55\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_full_2b_rector_pie.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_full_1a_semgrep_severity.png}
...
\begin{figure}[h]
    \centering
    \includegraphics[width=0.95\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_full_1b_semgrep_vulntype.png}
    \caption{Temuan Semgrep \textit{pre-scan} vs 
...
\textit{file}, yaitu \texttt{system/core/Output.php}, yang 
...
\texttt{system/core/Output.php}. Hasil ini menunjukkan bahwa 
...
\textit{deepseek-coder:6.7b} melalui Ollama memproses seluruh 
11 temuan dan menghasilkan saran perbaikan dengan rata-rata 
\textit{confidence} 80\%. Satu-satunya pengecualian adalah 
...
dan fungsi \textit{helper} yang diinjeksi secara dinamis — kategori yang
sama juga terdapat pada dataset FT UGM. Distribusi temuan berdasarkan
kontrol ISO/IEC 27001:2022 ditunjukkan pada Gambar~\ref{fig:phpstan-iso-dti}.

\begin{figure}[h]
    \centering
    \includegraphics[width=\textwidth]{contents/chapter-4/dti/pipeline_chart_cbt_full_3_phpstan_iso.png}
...
& \textbf{Status} \\
\hline \hline
A.5.17 & \textit{Authentication Information} & Tidak ada temuan 
\textit{hardcoded credentials} & \texttt{COMPLIANT} \\
\hline
A.8.24 & \textit{Use of Cryptography} & Tidak ada temuan 
penggunaan \texttt{md5()}/\texttt{sha1()} untuk kata sandi 
& \texttt{COMPLIANT} \\
\hline
A.8.25 & \textit{Secure Development Lifecycle} & 1.140 temuan 
PHPStan (mayoritas \textit{false positive} CI3) 
& \texttt{NON\_COMPLIANT} \\
\hline
A.8.26 & \textit{Application Security Requirements} & 1 temuan 
SQL Injection dari Semgrep (\texttt{Output.php}, CI3 
\textit{framework}) & \texttt{NON\_COMPLIANT} \\
\hline
A.8.28 & \textit{Secure Coding} & 2.113 temuan PHPStan dan 
temuan Semgrep aktif & \texttt{NON\_COMPLIANT} \\
\hline
A.8.29 & \textit{Security Testing in Development} & 10 temuan 
SSRF dari Semgrep masih terbuka & \texttt{NON\_COMPLIANT} \\
\hline
\end{tabularx}
\end{table}
...
kustomnya. Perbedaan lain adalah durasi eksekusi: FT UGM membutuhkan 
sekitar 41 menit karena eksperimen komparasi LLM dijalankan 
terhadap 11 temuan Semgrep dengan lima model dan 165 total 
percobaan. CBT DTI membutuhkan waktu lebih singkat karena AI 
Engine hanya menjalankan satu kali inferensi per temuan 
menggunakan model \textit{default} tanpa eksperimen multi-model.