...
\hline
\textbf{Penelitian ini} & PHP & Membamdingkan 5 LLM lokal dan memilih AI terbaik untuk migrasi PHP & Migrasi versi + \textit{security compliance} \\
\hline
\end{longtable}
...
dihasilkan model dapat lulus serangkaian pengujian. Pada nilai $k=1$
dengan \textit{greedy decoding}, pass@1 secara langsung mengukur persentase
percobaan yang menghasilkan kode valid dari total percobaan.
